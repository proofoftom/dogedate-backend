...
$api->version('v1', function ($api) {
    $api->group(['namespace' => 'App\Api\Controllers'], function ($api) {
        ...
        $api->group( [ 'middleware' => ['jwt.auth'] ], function ($api) {
            $api->get('doges', 'DogesController@index');
            $api->get('doges/{doge}', 'DogesController@show');
            $api->get('owner/{owner}/profile', 'OwnersController@show');
            $api->get('owner/{owner}/pack', 'OwnersController@pack');
